...
const MobileMenu: React.FC<Props> = ({setMobileMenuOpened, planetId, setPlanet}) => {
  ...
  return (
    <div className='mobileMenu'>
      <div className='mobileMenu__buttons'>
        {data.map((planet) => (
          <Link to={`${planet.name}`} className='mobileMenu__button' onClick={() => handleClick(planet)}>
            <span className={`mobileButton__logo mobileButton__logo--${data.indexOf(planet)}`}></span>
